...
const City = ({ city }: ICityProps) => {
  return (
    ...
    >
      <div
        data-city-pill
        className={`${styles.cityPin} flex items-center gap-[0.5rem] bg-[rgba(255,255,255,0.9)] backdrop-blur-sm pl-[0.625rem] pr-[0.875rem] py-[0.5rem] rounded-[1.875rem] whitespace-nowrap max-md:gap-[0.4rem] max-md:pl-[0.55rem] max-md:pr-[0.75rem] max-md:py-[0.4rem]`}
      >
